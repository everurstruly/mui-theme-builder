...
export default function DownloadButton() {
  const { title, getExportCode, mode, language, colorScheme } = useExport();
  ...
  return <Button onClick={handlePrimaryClick}>Download</Button>;
}
 ...
 */
function toPascalKebab(title: string | undefined): string {
  if (!title) return "";
