...
export function runAllTests() {
  console.log('🧪 Running ThemeWorkspace Tests\n');
...
if (typeof window !== 'undefined') {
  ...
  (window as unknown as { runThemeWorkspaceTests: () => boolean }).runThemeWorkspaceTests = runAllTests;
  console.log(
    '💡 Run tests in console with: window.runThemeWorkspaceTests()'
  );
}
