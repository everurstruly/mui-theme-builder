/**
 * Example: Complete ThemeWorkspace Demo
 * 
 * This file demonstrates all major features of the ThemeWorkspace module.
 */
...
function SaveDiscardControls() {
  const store = useThemeWorkspaceStore();
  const { canUndo, canRedo, undo, redo, historySize } = useThemeHistory();
...
// ===== Main Demo Component =====
export function ThemeWorkspaceDemo() {
  return (
...
export default ThemeWorkspaceDemo;
