...
import { editorExperiences, type EditorExperienceId } from "../editorExperience";
import { alpha, type SxProps } from "@mui/material";

type EditorThemeExperienceTabProps = {
  sx?: SxProps;
  centered?: boolean;
};

export default function EditorThemeExperienceTab({
  centered = false,
  ...rest
}: EditorThemeExperienceTabProps) {
